...
const Footer = () => {
  return (
    ...
    <div className="container-l align-item-center ">
   ...
   <footer className="footer-upeer-strip py-4">
    ...
    <div className="row">
      <div className="col-3">
        <h4 className="mb-4 newchange">Contact Us</h4>
        <div>
      ...
      <div className="col-3">
        <h4 className="mb-4  newchange">Information</h4>
        <div>
      ...
      <div className="col-3">
        <h4 className="mb-4 newchange">Account</h4>
        <div>
          <div className="footer-links d-flex flex-column">
      ...
      <div className="col-3">
        <h4 className="mb-4 newchange">Quick Links</h4>
        <div className="footer-links d-flex flex-column">
